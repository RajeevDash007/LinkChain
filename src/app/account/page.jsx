  ...
  return (
    <div>
     <form action={getUsername}>
        ...
        <input type="text" name="username" className='block p-2 mx-auto border-2 rounded-lg dark:border-yellow-400 border-purple-500 dark:bg-purple-200 bg-yellow-100 mb-4' placeholder='Your username' defaultValue={desiredUsername} />
